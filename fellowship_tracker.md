...
>
> All deadlines are approximate annual recurrences — verify on official sites each cycle.

---

## ⚡ Upcoming Deadlines (Next 90 Days)

Window: Jun 24 – Sep 22, 2026

| Fellowship | ~Deadline | ~Days Away | Action Needed |
|-----------|----------|-----------|---------------|
| [**IBM PhD Fellowship**](https://research.ibm.com/university/awards/fellowships.html) | ~Aug 31, 2026 | ~68 days | Faculty advisor must nominate — confirm with advisor in July |
| [**Apple Scholars in AI/ML**](https://machinelearning.apple.com/updates/apple-scholars-aiml) | ~Early Sep 2026 | ~73 days | University nominates ≤5 — confirm UF internal deadline with grad school (typically 2–3 weeks before Apple's date) |
| [**NVIDIA Graduate Fellowship**](https://research.nvidia.com/graduate-fellowships) | ~Mid-Sep 2026 | ~83 days | Self-apply — no nomination needed; start drafting GPU/VLM research pitch now |
| [**Meta Research PhD Fellowship**](https://research.facebook.com/fellowship/) | Sep 20, 2026 | ~88 days | Applications open Aug 3 — no nomination needed; draft research statement now; ref letters due Oct 6 |
...
## 📋 Industry & Big Tech Fellowships

> Sorted by approximate annual deadline (Jan → Dec).
...
| [**NVIDIA Graduate Fellowship**](https://research.nvidia.com/graduate-fellowships) | NVIDIA | ~Mid-Sep | Up to $60K (1 yr) + mandatory paid summer internship at NVIDIA | 1 yr | **Self-apply** (open) | PhD year 2+; CS, EE, or related | ML, VLM, CV, Agents | No nomination barrier — one of the most accessible top fellowships. Mandatory internship is a pro if you want industry exposure. GPU-heavy ML/VLM work is an excellent fit |
| [**Meta Research PhD Fellowship**](https://research.facebook.com/fellowship/) | Meta | ~Mid-Sep | Full tuition + $42K/yr stipend + conference travel | 2 yrs | **Self-apply** (open) | Full-time PhD; any year; AI-relevant research | ML, VLM, LLM, Agents | Fully open application — no nomination needed. Opens Aug 3; deadline Sep 20. One of the easiest high-value fellowships to apply to |
| [**Two Sigma PhD Fellowship**](https://www.twosigma.com/academic-partnerships/phd-fellowship/) | Two Sigma | ~Nov | $10K + paid summer internship | 1 yr | **Self-apply** | PhD in CS, stats, math, or related; any nationality | ML, UQ | Quantitative/theory-heavy focus; UQ, calibration, and probabilistic ML work fits well |
| [**Adobe Research GEM Fellowship**](https://research.adobe.com/fellowship/) | Adobe Research | ~Nov | $10K award + Adobe mentor + internship interview + 1-yr Creative Cloud | 1 yr | University nomination | PhD in relevant fields | VLM, LLM, CV | Covers CV, NLP, HCI — VLM and multimodal research is a strong match |
| [**Microsoft Research Fellowship**](https://www.microsoft.com/en-us/research/academic-program/phd-fellowship/) | Microsoft Research | ~Dec | $42K/yr stipend + MSR lab collaboration | 2 yrs | Faculty nomination | PhD year 3+ (standard); year 2+ for Ada Lovelace variant | ML, VLM, LLM, Agents | Ada Lovelace variant: year 2+, underrepresented, 3 yrs of funding. Multimodal learning and AI agents are explicit focus areas at MSR |
| [**Qualcomm Innovation Fellowship**](https://www.qualcomm.com/research/university-relations/innovation-fellowship) | Qualcomm | ~Dec | Up to $40K/team + mentorship | 1 yr | Team of 2 PhD students + faculty | PhD teams; Qualcomm-relevant AI; N. America/Europe regions | ML, VLM, Agents | Team-based — requires a co-applicant PhD student. Edge AI and on-device inference research fits well |
| [**Intel PhD Fellowship**](https://src.secure-platform.com/a/page/ISFP) | Intel / SRC | ~Mar (varies) | $60K/yr × 3 yrs | 3 yrs | University nomination | PhD in semiconductor-related fields; restricted to specific invited universities (OH, OR, AZ, NM) | ML, Agents | ⚫ Restructured — now semiconductor talent pipeline via SRC; not a general CS/AI fellowship. Restricted to specific invited universities; **not applicable for UF AI/ML students** |

---

## 📋 Federal & Government Fellowships

> Most require US citizenship or permanent residency — check eligibility before investing time.
...
## 📋 Foundation & Independent Fellowships
...
## 🗺️ Research Relevance Map

| Fellowship | ML | VLM | LLM | UQ | Agents | CV |
|-----------|:--:|:---:|:---:|:--:|:------:|:--:|
| Google PhD Fellowship | ✓✓ | ✓ | ✓ | ✓ | ✓ | — |
...
### Open Application vs. Nomination Required
| Self-apply directly | Must go through UF / advisor |
|--------------------|------------------------------|
| Meta, NVIDIA, NSF GRFP, DOE CSGF, NDSEG, SMART, Hertz, Open Phil, Two Sigma, Jane Street, **Anthropic Fellows**, **OpenAI Safety** | Google PhD, Amazon, Apple, IBM, Adobe, Microsoft, Qualcomm |
